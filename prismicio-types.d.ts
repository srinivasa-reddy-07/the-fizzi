...
export interface CarouselSliceDefaultPrimary {
  ...
  /**
   * Total Price field in *Carousel → Default → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: carousel.default.primary.total_price
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  total_price: prismic.RichTextField;
}
...
export interface HeroSliceDefaultPrimary {
  ...
  /**
   * Tins Image field in *Hero → Default → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: hero.default.primary.tins_image
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  tins_image: prismic.ImageField<never>;
